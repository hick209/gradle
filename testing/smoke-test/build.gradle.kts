...
dependencies {
    ...
    smokeTestImplementation(oldLibs.commonsIo)
    smokeTestImplementation(oldLibs.groovyJson)
    smokeTestImplementation(oldLibs.commonsHttpclient)
    smokeTestImplementation(oldLibs.jgit)
    smokeTestImplementation(oldLibs.spock)
    smokeTestImplementation(oldLibs.junitPlatform)
    smokeTestImplementation(oldLibs.jacksonDatabind)
